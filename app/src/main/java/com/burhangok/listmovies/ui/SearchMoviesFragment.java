...
import com.burhangok.listmovies.services.getMovieSearchInterface;
...
public class SearchMoviesFragment extends Fragment {
    ...
    View fragmentView;
    getMovieSearchInterface getServiceI;
    ...
    private Call<MoviesResponse> callResultsApi() {
        return getServiceI.getMovieSearch(
    ...
    public void init() {
        ...
        getServiceI = RetrofitConfig.getClient().create(getMovieSearchInterface.class);
    }
}
